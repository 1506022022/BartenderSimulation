...
public class Book : MonoBehaviour
{
    ...
    public Vector3 transformPoint(Vector3 mouseScreenPos)
    {
        ...
        else if (canvas.renderMode == RenderMode.WorldSpace)
        {
            ...
            if (HoldHand != null)
            {
                point = HoldHand.objectAttachmentPoint.transform.position;
    ...
    public void UpdateBook()
    {
        ...
        f = Vector3.Lerp(f, transformPoint(point), Time.deltaTime * 10);
    ...
    public void OnMouseDragRightPage()
    {
        if (interactable)
        {
            ...
            print(point);
            DragRightPageToPoint(transformPoint(point));
        }
    ...
    public void OnMouseDragLeftPage()
    {
        if (interactable)
        {
            ...
            print(point);
            DragLeftPageToPoint(transformPoint(point));
        }
